...
local tasklist_buttons = gears.table.join(
 ...
 awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "control", "2", "3", "4", "5", "ventas", "p-chat", "personal", "mail" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "e", function() logout_popup.launch() end, {description = "Show logout screen", group = "custom"}),
    ...
    awful.key({ "Shift" }, "Print", function() awful.spawn("flameshot gui") end,
              {description = "select range to screenshot", group = "hotkeys"}),
    -- emacsclient

    awful.key({ modkey,           }, "i", function() awful.spawn("emacsclient -c -a 'emacs'") end,
              {description = "Launch emacsclient", group = "hotkeys"}),

    -- browser

    awful.key({ modkey,           }, "o", function() awful.spawn("chromium") end,
              {description = "Launch chromium", group = "hotkeys"}),
